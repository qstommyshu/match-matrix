      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-xs text-neon-purple hover:text-neon-blue transition-colors">
                Forgot password?
              </Link>
            </div>
            <Input 
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="text-center text-sm">
            ...
            <Link to="/register" className="text-neon-purple hover:text-neon-blue font-medium transition-colors">
              Register
            </Link>
          </div>
        </CardFooter>
